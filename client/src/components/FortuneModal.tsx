      ...
      <DialogContent className="sm:max-w-md rounded-lg border-none shadow-lg">
        <div className="relative overflow-hidden rounded-lg">
          ...
          <div className="relative z-10 p-6 text-center">
            <DialogTitle className="text-xl text-white mb-6 mt-2 bg-gradient-to-r from-pink-400 to-purple-500 rounded-lg py-2 shadow-md border border-pink-200 font-bold">✨ 오늘의 운세 ✨</DialogTitle>
            ...
            {!isRevealing ? (
              ...
              <AnimatePresence>
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                  className="bg-gradient-to-br from-pink-300 to-purple-600 backdrop-blur-sm rounded-lg p-6 shadow-xl border-2 border-yellow-200"
                >
                  {/* 운세 메시지 */}
                  <motion.div 
                    initial={{ opacity: 0 }}
                  ...
                  >
                    ...
                    <p className="text-xl text-white font-bold py-3 border-b border-white border-opacity-30">
                      {fortune?.message}
                    </p>
                  </motion.div>
